...
const DeviceBoxInfoItem: FC<TDeviceBoxInfoItem> = ({
  ...
  <div
    className='flex flex-col bg-slate-200 dark:bg-slate-500 min-w-[100px] max-h-[60px] min-h-[60px] w-fit h-fit rounded-lg justify-center items-center p-2 transition-colors duration-200 hover:bg-slate-600'
    { ...restProps }
  >
    { Icon && (
    <Icon
